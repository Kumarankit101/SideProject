      ...
      >
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Button
            variant="glowing"
            size="pill"
            className={`border-[#DDF695]/50 text-[#DDF695] shadow-[0_0_30px_rgba(221,246,149,0.4)] hover:text-white hover:border-white/70 px-12 py-8 text-xl md:text-2xl h-auto transition-all duration-500 transform hover:scale-105 relative z-50 ${
