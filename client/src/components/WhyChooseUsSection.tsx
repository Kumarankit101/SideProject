...
const FeatureCard = ({ icon, title, description }: FeatureCardProps) => {
  return (
    <div className="relative group perspective-1000">
      ...
      <div className="absolute inset-0 border border-[#DDF695]/20 rounded-lg transition-all duration-500 
        ...
        before:blur-xl before:transform before:animate-pulse-slow"></div>
      
      {/* Card content with 3D transform effect */}
      <div className="bg-[#1E1E1E] rounded-lg p-8 h-full transition-all duration-500 group-hover:scale-105 
  ...
  const features = [
    {
      ...
      description: "We foster a supportive environment where entrepreneurs can share ideas, receive feedback, and connect with like-minded collaborators to turn concepts into reality."
    },
    {
      icon: <Zap className="w-14 h-14" />,
      title: "Access to Resources",
      description: "Our platform provides connections to investors, mentors, and educational resources that help you transform your side project into a successful venture."
    },
    {
      icon: <Brain className="w-14 h-14" />,
      title: "Idea Validation & Refinement",
      description: "Test your concept with our community of entrepreneurs and experts who provide valuable insights to help refine and improve your project before launch."
    }
  ];

  return (
    <section className="py-24 bg-[#171817]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-400 text-lg">
            Our platform is designed to support entrepreneurs at every stage of their journey, from idea conception to successful launch.
          </p>
        </div>
